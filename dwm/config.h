...
static char *fonts[]          = { "monospace:size=12", "JoyPixels:pixelsize=10:antialias=true:autohint=true", "fontawesome:size=12" };
static char normbgcolor[]           = "#000000";
static char normbordercolor[]       = "#637599";
static char normfgcolor[]           = "#bbbbbb";
static char selfgcolor[]            = "#eeeeee";
static char selbordercolor[]        = "#feea89";
static char selbgcolor[]            = "#637599";
...
static Key keys[] = {
	...
	{ MODKEY,			XK_f,		spawn,		SHCMD(TERMINAL " -e thunderbird ; pkill -RTMIN+12 dwmblocks; rmdir ~/.abook") },
	{ MODKEY|ShiftMask,		XK_f,		spawn,		SHCMD(TERMINAL " -e abook -C ~/.config/abook/abookrc --datafile ~/.config/abook/addressbook") },
// 	{ MODKEY,			XK_p,		spawn,		SHCMD(TERMINAL " -e lf") },
	{ MODKEY|ShiftMask,		XK_p,		spawn,		SHCMD(TERMINAL " -e htop") },
...
// 	{ MODKEY,			XK_,		incnmaster,     {.i = +1 } },
	...
	{ MODKEY,			XK_semicolon,			spawn,		SHCMD("mpc toggle") },
	{ MODKEY|ShiftMask,		XK_semicolon,			spawn,		SHCMD("mpc pause ; pauseallmpv") },
	...
	{ MODKEY,			XK_k,		spawn,		SHCMD(TERMINAL " -e nvim -c VimwikiIndex") },
...
//     My modkeys
	...
	{ MODKEY,			XK_m,		spawn,		SHCMD("keepassxc") },
	{ MODKEY,			XK_p,		spawn,		SHCMD("brave") },
	{ MODKEY,			XK_y,		spawn,		SHCMD("obsidian") },
	{ MODKEY,			XK_l,		spawn,		SHCMD("virt-manager") },
	{ MODKEY,			XK_c,		spawn,		SHCMD("veracrypt") },
	{ MODKEY,			XK_semicolon,		spawn,		SHCMD(TERMINAL "-e cd ~/Uni | ls .") },
	{ MODKEY,			XK_r,		spawn,		SHCMD("atom") },
